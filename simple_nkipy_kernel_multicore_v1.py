#!/usr/bin/env python3
"""
Multi-Core Matrix Multiplication v1 — async dispatch + device-side tracing
...
Uses NEURON_RT_ASYNC_EXEC_MAX_INFLIGHT_REQUESTS for async dispatch and a single
SystemTraceSession (all cores) for accurate device-side timing via NeuronCore
hardware clocks.
"""
...
def main():
    print("=" * 80)
    print("Multi-Core Matrix Multiplication v1 (async + device tracing)")
    print("=" * 80)
    ...
    bytes_per_gemm = 3 * size * size * 1  # fp8 = 1 byte
